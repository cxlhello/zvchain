...
func TestValidateAddress(t *testing.T) {
	...
	if common.ValidateAddress("0xiop1222222223333333333333232322222222222222222222222222222222222") {
		t.Errorf("wrong letters")
	}
	if common.ValidateAddress("0x33333333333333333333333333333333333333333333333333333333333333333333333333") {
		t.Errorf("too long")
	}
	if !common.ValidateAddress("0x1231222222223333333333333232322222222222222222222222222222222222") {
		t.Errorf("correct")
	}
}
